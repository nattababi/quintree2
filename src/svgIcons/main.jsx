...
const svgProfileIcon = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-person-fill m-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path fillRule="evenodd" d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
  </svg>

const svgSignoutIcon = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-door-open m-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const svgHistoryIcon = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-clock-history m-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export { svgUserIcon, svgProfileIcon, svgSignoutIcon, svgHistoryIcon }