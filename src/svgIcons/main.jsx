...
const svgUserIcon = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-person-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path fillRule="evenodd" d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
  </svg>;

const svgProfileIcon = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-person-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style={{marginTop: '-2px'}}>
    <path fillRule="evenodd" d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
  </svg>

const svgProfileIconNotFilled = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-person m-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
{/* <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-file-x m-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const svgGroupIcon = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-people-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style={{marginTop: '-2px'}}>
...
const svgSignoutIcon = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-door-open" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style={{marginTop: '-2px'}}>
...
const svgHistoryIcon = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-clock-history" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style={{marginTop: '-2px'}}>
...
const svgLoginIcon = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-person-lines-fill m-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const svgRegisterIcon = <svg width="16" height="16" fill="currentColor" className="bi bi-person-plus" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" style={{marginTop: '-3px'}}>
    <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H1s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C9.516 10.68 8.289 10 6 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
    <path fillRule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"/>
  </svg>

const svgExistsIcon = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-receipt" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const svgSessionIdIcon = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-tag-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style={{marginTop: '-1px'}}>
...
const svgPhoneIcon = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-telephone m-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const svgCalendarIcon = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-calendar3 m-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const svgCompliantIcon = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-chat-left-dots m-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const svgOverreadIcon = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-file-text m-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path fillRule="evenodd" d="M4 0h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2zm0 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H4z"/>
...
const svgInviteIcon = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-envelope" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style={{marginTop: '-3px'}}>
...
const svgFolderIcon = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-folder" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const svgFolderIconFilled = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-folder-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const svgArrowUp = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-arrow-up" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path fillRule="evenodd" d="M8 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L7.5 2.707V14.5a.5.5 0 0 0 .5.5z" />
  </svg>

const svgArrowDown = <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-arrow-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path fillRule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1z" />
  </svg>

const svgKeyIcon = <svg width="16" height="16" fill="currentColor" className="bi bi-key" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" style={{marginTop: '-2px'}}>
    <path d="M0 8a4 4 0 0 1 7.465-2H14a.5.5 0 0 1 .354.146l1.5 1.5a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0L13 9.207l-.646.647a.5.5 0 0 1-.708 0L11 9.207l-.646.647a.5.5 0 0 1-.708 0L9 9.207l-.646.647A.5.5 0 0 1 8 10h-.535A4 4 0 0 1 0 8zm4-3a3 3 0 1 0 2.712 4.285A.5.5 0 0 1 7.163 9h.63l.853-.854a.5.5 0 0 1 .708 0l.646.647.646-.647a.5.5 0 0 1 .708 0l.646.647.646-.647a.5.5 0 0 1 .708 0l.646.647.793-.793-1-1h-6.63a.5.5 0 0 1-.451-.285A3 3 0 0 0 4 5z"/>
    <path d="M4 8a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/>
  </svg>

export { svgUserIcon, svgProfileIcon, svgSignoutIcon, svgHistoryIcon, svgLoginIcon, svgRegisterIcon, 
    svgExistsIcon, svgSessionIdIcon, svgGroupIcon, svgPhoneIcon, svgCalendarIcon, 
    svgProfileIconNotFilled, svgCompliantIcon, svgOverreadIcon, svgInviteIcon, svgFolderIcon,
    svgFolderIconFilled, svgArrowUp, svgArrowDown, svgKeyIcon }