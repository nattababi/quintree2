...
class HistoryTable extends Component {
  ...
  columns = [{
    ...
    label: '', 
    style: { minWidth: '20px' },
    icon: <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-receipt" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  { path: 'sessionId',
    label: 'ID',
    style: { minWidth: '40px' },
    icon: <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-tag-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  { path: 'started',
    ...
    style: { minWidth: '40px' },
    icon: <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-clock-history" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  { path: 'provider',
    label: 'Provider',
    style: { minWidth: '60px' },
    icon: <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-person-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
