    ...
    return (
      <div className={styles['flex-container']}>
        <div className={styles['flex-child-provider']}>
          <div>
            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-telephone m-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <div>
            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-calendar3 m-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            {this.formatTime(item.patient.dob)}
          </div>
          <div>
            ...
            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-person m-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" d="M10 5a2 2 0 1 1-4 0 2 2 0 0 1 4 0zM8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm6 5c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
            </svg>
            {item.patient.gender}
          </div>
          <div>
            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-chat-left-dots m-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className={styles['flex-container']}>
            <div className={styles['flex-child-icon']}>
              <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-file-text m-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" d="M4 0h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2zm0 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H4z"/>
